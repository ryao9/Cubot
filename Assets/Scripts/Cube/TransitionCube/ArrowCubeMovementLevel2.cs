...
public class ArrowCubeMovementLevel2 : MonoBehaviour
{
    // for scene fading
    ...
    {
        // mesh 0
        if (Mathf.Approximately(mesh0.transform.position.x, 7.5f)
                    && Mathf.Approximately(mesh0.transform.position.y, 3.06f)
                    && Mathf.Approximately(mesh0.transform.position.z, 44.5f))
        {
            mesh0_done = true;
        }
        else
        ...
        // mesh 1
        if (Mathf.Approximately(mesh1.transform.position.x, 6.5f)
                    && Mathf.Approximately(mesh1.transform.position.y, 3.06f)
                    && Mathf.Approximately(mesh1.transform.position.z, 43.5f))
        {
            mesh1_done = true;
        }
        else
        ...
        // mesh 2
        if (Mathf.Approximately(mesh2.transform.position.x, 7.5f)
                    && Mathf.Approximately(mesh2.transform.position.y, 3.06f)
                    && Mathf.Approximately(mesh2.transform.position.z, 43.5f))
        {
            mesh2_done = true;
        }
        else
        ...
        // mesh 3
        if (Mathf.Approximately(mesh3.transform.position.x, 8.5f)
                    && Mathf.Approximately(mesh3.transform.position.y, 3.06f)
                    && Mathf.Approximately(mesh3.transform.position.z, 43.5f))
        {
            mesh3_done = true;
        }
        else
        ...
        // mesh 4
        if (Mathf.Approximately(mesh4.transform.position.x, 7.5f)
                    && Mathf.Approximately(mesh4.transform.position.y, 3.06f)
                    && Mathf.Approximately(mesh4.transform.position.z, 42.5f))
        {
            mesh4_done = true;
        }
        else
    ...
    {
        Renderer[] children;
        children = cube1.GetComponentsInChildren<Renderer>();
    ...
    {
        foreach (Transform child in cube1.transform)
        {
    ...
    IEnumerator MovingUp()
    {
        ...
        if (cube1.GetComponent<CubeRotate>() != null) cube1.GetComponent<CubeRotate>().enabled = false;
        if (cube1.GetComponent<CubeReset>() != null) cube1.GetComponent<CubeReset>().enabled = false;
        if (cube1.GetComponent<CubeController>() != null) cube1.GetComponent<CubeController>().enabled = false;
        if (cube1.GetComponent<RotateHighlight>() != null) cube1.GetComponent<RotateHighlight>().enabled = false;
        ChangeMaterial();
        ...
        SceneManager.LoadScene("Beta_Level3");
    }
