...
public class ArrowCubeMovementLevel1 : MonoBehaviour
{
    // for scene fading
    ...
    {
        // mesh 0
        if (Mathf.Approximately(mesh0.transform.position.x, 10.5f)
        ...
        // mesh 1
        if (Mathf.Approximately(mesh1.transform.position.x, 9.5f)
        ...
        // mesh 2
        if (Mathf.Approximately(mesh2.transform.position.x, 10.5f)
        ...
        // mesh 3
        if (Mathf.Approximately(mesh3.transform.position.x, 11.5f)
        ...
        // mesh 4
        if (Mathf.Approximately(mesh4.transform.position.x, 10.5f)
    ...
    IEnumerator MovingUp()
    {
        ...
        cube1.GetComponent<CubeRotate>().enabled = false;
        cube1.GetComponent<CubeReset>().enabled = false;
        cube1.GetComponent<CubeController>().enabled = false;
        cube1.GetComponent<RotateHighlight>().enabled = false;
        ChangeMaterial();
        ...
        SceneManager.LoadScene("Alpha_Level2");
    }
}
